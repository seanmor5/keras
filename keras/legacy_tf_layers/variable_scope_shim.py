...
class VariableScopeModule(tf.Module):
  ...
  layer = WrappedDoubleDenseModule10)
  ...
  Caveats:
    ...
    * If you would like to nest modules or other
      ...
      assign them as attributes of your VariableScopeModule so that
      object-oriented weights and loss tracking will kick in for them.
      Only weights made by `tf.compat.v1.get_variable` calls and
      `tf.compat.v1.layers` will get implicitly tracked. Note: if these
